...
public class DataTracker {
	 ...
	 * called whenever a network connection is made.
	 *
	 * @param data
	 *            The amount of data (in bytes) to add to the total data used
	 */
	...
	/**
	 * Gets the amount of data in megabytes used by the program. Note that the
	 * double only extends out two decimal places.
	 *
