...
public class ErrorHandler {
	...
	/**
	 * Displays a window clearly indicating something has gone wrong. This
	 * should be used only when the program encounters an error that impedes its
	...
	/**
	 * Shows the error information of t. It outputs all the information into an
	 * {@link Error} window. This should only be accessible from a currently
	 * open {@link Error}.
	 *
	 * @param t
	 *            The error object
